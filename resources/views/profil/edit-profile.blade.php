...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <h2 class="text-center" style="font-family: Lucida Sans" style="color: rgb(78, 71, 61)">Edit Data Profile</h2>

        <form action="/profile/{{ auth()->user()->id }}" method="POST" enctype="multipart/form-data" class="m-4">
            @method('put')
            @csrf
