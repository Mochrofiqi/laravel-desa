...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <h2 class="text-center" style="font-family: Lucida Sans" style="color: rgb(78, 71, 61)">Tambah Data Jenis Bansos</h2>

        <form action="/jenis_bantuan" method="POST" class="m-4">
            @csrf
